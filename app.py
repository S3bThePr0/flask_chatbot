...
def check_all_messages(message):
    ...
    if math_operation:
        ...
        response(f"It does {math_result}", list_of_words=["how", "much", "does"], required_words=["how", "does"])
    response("Hello!", list_of_words=["hello", "hi", "hey", "heyo", "sup"], single_response=True)
    response("I'm doing fine, and you?", list_of_words=["how", "are", "you", "doing"], required_words=["how" "you"])
    ...
    response("Goodbye!", list_of_words=["bye", "goodbye", "see", "soon"], single_response=True)
